...
from branch_api.api.auth_api import auth_api_bp
from branch_api.api.branch_api import branch_api_bp
...
def create_app():
    ...
    app.config["APP_ROLE"] = "branch"
    app.config["SWAGGER"] = {
        "title": "Tech Store Branch API",
        "uiversion": 3,
        "openapi": "3.0.2",
        "specs_route": "/apidocs/",
        "components": {
    ...
    def ping():
        return {
            "service": "branch-api",
            "branch_code": app.config.get("BRANCH_CODE"),
            "status": "ok",
        }
