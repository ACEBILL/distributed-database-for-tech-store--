...
(N'NV001', N'Nguyễn Văn Hùng',    N'001099001001', N'0901000001', 50000000, CONVERT(NVARCHAR(255), HASHBYTES('SHA2_256', 'pass123'), 2), 1, 1, 250, N'giam_doc',    '2020-01-01', NULL),
(N'NV002', N'Trần Thị Mai',       N'001099002002', N'0901000002', 25000000, CONVERT(NVARCHAR(255), HASHBYTES('SHA2_256', 'pass123'), 2), 1, 2, 200, N'truong_phong','2020-06-01', NULL),
(N'NV003', N'Lê Hoàng Nam',       N'001099003003', N'0901000003', 18000000, CONVERT(NVARCHAR(255), HASHBYTES('SHA2_256', 'pass123'), 2), 1, 2, 180, N'pho_phong',   '2021-01-15', NULL),
(N'NV004', N'Phạm Thị Hương',     N'001099004004', N'0901000004', 12000000, CONVERT(NVARCHAR(255), HASHBYTES('SHA2_256', 'pass123'), 2), 1, 2, 150, N'nhan_vien',   '2022-03-01', NULL),
(N'NV005', N'Hoàng Đức Anh',      N'001099005005', N'0901000005', 12000000, CONVERT(NVARCHAR(255), HASHBYTES('SHA2_256', 'pass123'), 2), 1, 2, 140, N'nhan_vien',   '2022-06-15', NULL),
(N'NV006', N'Vũ Thị Lan',         N'001099006006', N'0901000006', 11000000, CONVERT(NVARCHAR(255), HASHBYTES('SHA2_256', 'pass123'), 2), 1, 2, 120, N'nhan_vien',   '2023-01-10', NULL),
(N'NV007', N'Đặng Minh Tuấn',     N'001099007007', N'0901000007', 28000000, CONVERT(NVARCHAR(255), HASHBYTES('SHA2_256', 'pass123'), 2), 1, 3, 220, N'truong_phong','2020-03-01', NULL),
(N'NV008', N'Bùi Thị Ngọc',       N'001099008008', N'0901000008', 20000000, CONVERT(NVARCHAR(255), HASHBYTES('SHA2_256', 'pass123'), 2), 1, 3, 190, N'pho_phong',   '2021-02-01', NULL),
(N'NV009', N'Ngô Quốc Bảo',       N'001099009009', N'0901000009', 15000000, CONVERT(NVARCHAR(255), HASHBYTES('SHA2_256', 'pass123'), 2), 1, 3, 160, N'nhan_vien',   '2022-01-10', NULL),
(N'NV010', N'Đỗ Thị Phương',      N'001099010010', N'0901000010', 14000000, CONVERT(NVARCHAR(255), HASHBYTES('SHA2_256', 'pass123'), 2), 1, 3, 140, N'nhan_vien',   '2022-08-01', NULL),
(N'NV011', N'Lý Văn Thành',       N'001099011011', N'0901000011', 22000000, CONVERT(NVARCHAR(255), HASHBYTES('SHA2_256', 'pass123'), 2), 1, 4, 200, N'truong_phong','2020-04-01', NULL),
(N'NV012', N'Trịnh Thị Hà',       N'001099012012', N'0901000012', 13000000, CONVERT(NVARCHAR(255), HASHBYTES('SHA2_256', 'pass123'), 2), 1, 4, 130, N'nhan_vien',   '2022-05-01', NULL),
(N'NV013', N'Cao Đức Mạnh',       N'001099013013', N'0901000013', 12000000, CONVERT(NVARCHAR(255), HASHBYTES('SHA2_256', 'pass123'), 2), 1, 4, 110, N'nhan_vien',   '2023-02-15', NULL),
(N'NV014', N'Hồ Thị Yến',         N'001099014014', N'0901000014', 24000000, CONVERT(NVARCHAR(255), HASHBYTES('SHA2_256', 'pass123'), 2), 1, 5, 210, N'truong_phong','2020-05-01', NULL),
(N'NV015', N'Dương Văn Khoa',     N'001099015015', N'0901000015', 13000000, CONVERT(NVARCHAR(255), HASHBYTES('SHA2_256', 'pass123'), 2), 1, 5, 145, N'nhan_vien',   '2022-04-01', NULL),
(N'NV016', N'Phan Thị Trang',     N'001099016016', N'0901000016', 12000000, CONVERT(NVARCHAR(255), HASHBYTES('SHA2_256', 'pass123'), 2), 1, 5, 120, N'nhan_vien',   '2023-03-01', NULL),
(N'NV017', N'Mai Văn Đức',        N'001099017017', N'0901000017', 23000000, CONVERT(NVARCHAR(255), HASHBYTES('SHA2_256', 'pass123'), 2), 1, 6, 205, N'truong_phong','2020-07-01', NULL),
(N'NV018', N'Tạ Thị Linh',       N'001099018018', N'0901000018', 15000000, CONVERT(NVARCHAR(255), HASHBYTES('SHA2_256', 'pass123'), 2), 1, 6, 160, N'pho_phong',   '2021-06-01', NULL),
